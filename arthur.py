...
# === KONFIGURASI ===
api_id = 26828090  # Ganti dengan milikmu dari my.telegram.org
api_hash = '068224a607cbdedc84f106f74d67b3a6'
...
async def schedule_cmd(event):
    ...
    try:
        ...
        for hari_eng in hari_list:
            ...
            scheduler.add_job(
                forward_job,
                trigger=CronTrigger(day_of_week=hari_eng, hour=jam, minute=minit),
